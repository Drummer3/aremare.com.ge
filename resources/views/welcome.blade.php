<x-guest-layout>
    ...
    <div class="card">
        ...
        <ul class="list-disc list-inside mt-6 space-y-3 max-w-xl mx-auto">
            ...
            <li class="font-bold">{{ __('მომხმარებელზე მორგებული პირობები და ფასები') }}</li>
            <li>{{ __('სტარტაპებისთვის ხელშეწყობა') }}</li>
        </ul>
    </div>
    ...
    <div class="card">
        <p class="text-xl text-center font-bold">
            {{ __('პროგრამა "არემარე" გათვლილია ნებისმიერი ტიპის და სიდიდის ბიზნესის მართვაზე როგორც 10 კაცამდე, ასევე 100, 500 და მეტი ადამიანური რესურსის შემთხვევაში') }}
        </p>
    </div>
